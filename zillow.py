...
class login():
    ...
    def test(self):
        ...
        driver.get(baseUrl)
        setLocation = driver.find_element_by_xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/main[1]/div[1]/div[1]/section[1]/div[1]/div[1]/div[1]/form[1]/div[1]/input[1]")
        setLocation.click()
        setLocation.send_keys("Atlanta")
